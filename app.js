...
var baseUrls = {
    ...
    'UserServiceBaseUrl': 'http://192.168.1.102:3638/DVP/API/1.0.0.0/',//'http://userservice.app1.veery.cloud/DVP/API/1.0.0.0/',
    //'UserServiceBaseUrl': 'http://192.168.0.132:3637/DVP/API/1.0.0.0/',
    'authServiceBaseUrl': 'http://192.168.1.102:3638/oauth/',
    'authProviderUrl': 'http://192.168.1.102:3638/',
...
mainApp.config(["$httpProvider", "$stateProvider", "$urlRouterProvider", "$authProvider", "vcRecaptchaServiceProvider",
    function ($httpProvider, $stateProvider, $urlRouterProvider, $authProvider, vcRecaptchaServiceProvider) {
        ...
        var authProviderUrl = 'http://192.168.1.102:3638/auth/';
