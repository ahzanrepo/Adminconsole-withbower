...
mainApp.controller("detailsDashBoardController", function ($http, $scope, $rootScope, $filter, $stateParams, $anchorScroll, $timeout, $q, uiGridConstants, queueMonitorService, subscribeServices, agentStatusService, contactService, cdrApiHandler, ShareData, notifiSenderService, dashboardService, $state, $interval) {
	$anchorScroll();
