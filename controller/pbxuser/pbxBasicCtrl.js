...
(function() {
    ...
    var pbxBasicCtrl = function ($scope, $rootScope, pbxUserApiHandler)
    {
            ...
            pbxUserApiHandler.updatePABXUser($scope.basicConfig).then(function(data1)
                {
                    if(data1.IsSuccess)
                    {
                        ...
                        $rootScope.$emit('SetCurrentPABXUserStatus', {UserStatus: $scope.basicConfig.UserStatus, AdvancedRouteMethod: $scope.basicConfig.AdvancedRouteMethod});
