...
(function() {
    ...
    var myUserProfileApiAccess = function($http, authService)
    {
        ...
        var getMyProfile = function()
        {
            ...
            return $http({
                method: 'GET',
                url: 'http://userservice.104.131.67.21.xip.io/DVP/API/1.0.0.0/Myprofile',
                headers: {
        ...
        var addContactToMyProfile = function( contact, type)
        {
            ...
            return $http({
                method: 'PUT',
                url: 'http://userservice.104.131.67.21.xip.io/DVP/API/1.0.0.0/Myprofile/contact/' + contact,
                headers: {
                    'authorization': authToken
                },
                data:{
